...
@interface MessagesVC () <JSQMessagesViewAccessoryButtonDelegate>
@end
...
- (void)viewDidLoad
{
     ...
     */
    self.demoData = [[DemoModelData alloc] initWithSenderName:self.theSenderName];
    self.demoData.theSenderName = self.theSenderName;
